...
export const DEFAULT_HEADERS = {
  "accept": "text/html, */*",
  "accept-language": "it",  // Semplificato come il portale originale
  "cache-control": "no-cache",  // Aggiunto come il portale originale
  "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
  "pragma": "no-cache",  // Aggiunto come il portale originale
  "priority": "u=1, i",
  "sec-ch-ua": "\"Google Chrome\";v=\"134\", \"Not:A_Brand\";v=\"24\", \"Chromium\";v=\"134\"",
  "sec-ch-ua-mobile": "?0",
  "sec-ch-ua-platform": "\"Linux\"",  // Cambiato a Linux come originale
