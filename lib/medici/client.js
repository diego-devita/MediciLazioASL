...
export class MediciSearchClient {
  ...
  // ===== RICERCA MEDICI =====
  async searchMedici(surnames = [], commonParams = {}) {
    // Estrai e normalizza i parametri multipli
    const surnamesList = Array.isArray(surnames) ? surnames : [surnames];
    ...
    // Se namesList o zipsList sono vuoti dopo il parsing, usa stringa vuota
